...
function changeSelectOption() {
    ...
    switch (select.value) {
        case 'en':
            ...
            break;
        case 'ru':
            document.querySelector('form>input').setAttribute("placeholder", "Ваш адрес электронной почты");
            break;
        case 'be':
            document.querySelector('form>input').setAttribute("placeholder", "Ваш адрас электроннай пошты");
            break;
    }
}
